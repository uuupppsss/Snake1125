...
namespace ConsoleApp18
{
    partial class Program
    {
        ...
        static int[] kringe_apple = new int[2]; //координаты отравленного яблока
        ...
        static void Main(string[] args)
        {
            ...
            GenerateKringeApple();//генерация отравленного яблока
        ...
        private static void RunSnake()
        {
            while (gameRunning)
            {
                ...
                else if(SnakeEatKringeApple()) //проверка на то, что змейка съела отравленное яблоко
                {
                    DecreaseSnake();//уменьшение змеи
                    GenerateKringeApple();//создание нового отравленного яблока
                }
            }
        }
